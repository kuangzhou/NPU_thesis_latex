\def\CTeXPreproc{Created by ctex v0.2.13, don't edit!}% 若xelatex编译非UTF8文件，需在每个文件中指定字符编码;
...
%% 05/05/09 by B. Pan(panbinfeng@gmail.com)
\newcommand{\university}{西北工业大学}
...
\ifoneortwoside
  ...
  \fancyhead[CE]{\song \xiaowu \university \cxueke\cxuewei 学位论文 }%
  \fancyfoot[C,C]{\xiaowu --~\thepage~--} %\if@mainmatter \fi
\else%
  \fancyhead[CO]{\song \xiaowu \university \cxueke\cxuewei 学位论文}
  \fancyhead[CE]{\song \xiaowu \university \cxueke\cxuewei 学位论文}%
  \fancyfoot[C,C]{\xiaowu --~\thepage~--} %\if@mainmatter   \fi
\fi
...
\def\makecover{
    ...
    \begin{center} {\kai  \university}  \end{center} }
